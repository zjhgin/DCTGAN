...
parser.add_argument('--name', type=str,default="configs")
parser.add_argument('--dataset', type=str, default="flower")
parser.add_argument('--real_dir', type=str, default="results/flower_dctgan_base_index/reals")
parser.add_argument('--fake_dir', type=str,default="results/flower_dctgan_base_index/tests")
...
conf_file = os.path.join(args.name, 'flower_lofgan.yaml')
